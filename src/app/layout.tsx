...
const pageDescription =
  "Professional karate training in Regina focused on athlete development, discipline, confidence, fitness, and competitive excellence.";
