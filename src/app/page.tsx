        ...
        <section className="border-y border-white/10 bg-black py-16">
          <div className="section-shell">
            <article className="mx-auto grid max-w-5xl items-center gap-6 overflow-hidden rounded-2xl border border-red-400/25 bg-gradient-to-br from-stone-900 to-black p-6 shadow-2xl shadow-black/30 sm:p-8 md:grid-cols-[1fr_auto]">
              <div><p className="text-xs font-black uppercase tracking-[0.2em] text-red-300">Professional education</p><h2 className="hero-title mt-2 text-3xl font-bold text-white sm:text-4xl">Karate Knowledge Center</h2><p className="mt-4 max-w-3xl leading-7 text-stone-300">Explore professional educational resources covering karate refereeing, Kata, Kumite, Para Karate, competition rules, coaching, and athlete development.</p></div>
              <div><ButtonLink href="/karate-knowledge-center">Explore the Knowledge Center</ButtonLink></div>
            </article>
          </div>
        </section>
