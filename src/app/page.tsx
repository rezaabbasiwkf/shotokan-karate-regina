    ...
    <>
      ...
      <main id="home">
        <section className="relative min-h-[92vh] overflow-hidden pt-20">
          ...
          <div className="section-shell relative z-10 flex min-h-[calc(92vh-5rem)] items-start pb-20 pt-10 sm:pt-16 lg:pt-20">
            <div className="max-w-4xl">
              ...
              <h1 className="relative -top-4 karate-display whitespace-nowrap text-[2.35rem] font-black uppercase leading-[0.95] text-white max-[380px]:whitespace-normal max-[380px]:text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                Shotokan Karate Regina
              </h1>
              <p className="mt-10 max-w-xl text-lg leading-8 text-stone-100 drop-shadow-xl sm:text-xl">
