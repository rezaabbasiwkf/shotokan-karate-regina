...
export default function SelfDefensePage() {
  return <><Navbar /><main className="pt-20">
    ...
    <section id="self-defense-contact" className="bg-red-950/25 py-24 text-center"><div className="section-shell"><p className="text-xs font-black uppercase tracking-[0.28em] text-red-300">Take the next step</p><h2 className="hero-title mx-auto mt-4 max-w-3xl text-4xl font-bold text-white sm:text-5xl">Ask About Practical Self-Defense Training</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-stone-300">Register when you are ready, or contact Shotokan Karate Regina to find the right training option.</p><div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row"><ButtonLink href="/register">Register</ButtonLink><ButtonLink href="mailto:info@shotokan-karate-regina.com" variant="secondary">Contact</ButtonLink></div></div></section>
  </main><Footer /></>;
}
